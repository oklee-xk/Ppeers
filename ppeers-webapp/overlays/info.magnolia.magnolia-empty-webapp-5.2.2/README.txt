...
This package contains:
   ...
   Magnolia Core 5.2.2
   Magnolia Internationalization Framework 5.2.2
   Magnolia JAAS 5.2.2
   Magnolia Imaging Module 3.0.3
   Magnolia Legacy UI 5.2.2
   magnolia-module-mail 5.1.2
   Magnolia Rendering 5.2.2
   Magnolia Templating 5.2.2
   Magnolia Templating for JSP 5.2.2
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.2.2.html
